-- ReplicatedStorage/Modules/SkillConfig.lua
local T = require(script.Parent:WaitForChild("SkillTuning"))
...
cfg.aquabarrier = {
	element="Water",
	displayName="AquaBarrier",
	aliases={"AquaBarrier","Watershield"},
	...
	stats = function(lvl)
		...
		return {
			...
			duration = s.duration,
			cooldown = s.cooldown,
			shield = s.shield or 0, -- expose shield for HUD
			triggerEnemyCount = 2,
			triggerRange = 12,
			radiusVisual = 10,
		}
